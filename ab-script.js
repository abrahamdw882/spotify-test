...
// Helper function to fetch the thumbnail using the secondary API endpoint (spotifydl2)
...
async function fetchVideos() {
  ...
  try {
    ...
    data.results.forEach((song) => {
      ...
      imgEl.src = 'https://files.catbox.moe/nu3fxr.jpg';
      imgEl.alt = song.title;
      ...
      videoCard.appendChild(imgEl);
      videoCard.appendChild(infoDiv);
      resultsContainer.appendChild(videoCard);

      fetchThumbnail(song.url)
        .then(thumbnailUrl => {
